<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div style="display:flex; gap:8px;">
                @can('update', $hospedaje)
                    <a href="{{ route('hospedajes.edit', $hospedaje) }}"
                        style="background-color:#f59e0b; color:#ffffff; padding:8px 16px; border-radius:6px; font-weight:600; text-decoration:none;">
                        Editar Hospedaje
                    </a>
                @endcan
                @can('crear habitacion')
                    <a href="{{ route('hospedajes.habitaciones.create', $hospedaje) }}"
                        style="background-color:#2563eb; color:#ffffff; padding:8px 16px; border-radius:6px; font-weight:600; text-decoration:none;">
                        + Nueva Habitación
                    </a>
                @endcan
            </div>
            ...
            <!-- Habitaciones -->
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <h3 class="text-lg font-semibold mb-4">Habitaciones disponibles</h3>
...
<div class="bg-white shadow-sm sm:rounded-lg p-6">
        ...
        <div class="border-b py-3">
            <div class="flex justify-between items-start">
                ...
                <div style="display:flex; gap:8px;">
                    ...
                    {{-- Cliente puede eliminar solo su propio comentario --}}
    ...
    {{-- Formulario para clientes Y propietarios --}}
